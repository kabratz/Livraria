...
public class CadastroBairro extends javax.swing.JFrame {
    ...
    public CadastroBairro() {
        ...
        try {
            ...
            obCidade.PreencheCombo("SELECT id_cidade, nome FROM cidade");
        } catch (Exception e) {
    ...
    private void preencherCampos() {
        try {
            lblId.setText(String.valueOf(objBairro.getId_bairro()));
            txtNome.setText(objBairro.getNome());
            obCidade.SetaComboBox(String.valueOf(objBairro.getId_cidade()));
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        try {
            ...
            if (!lblId.getText().equals("ID")) {
                ...
                objBairro.setId_cidade(cbCidade.getSelectedIndex());
        ...
        if (jtbBairro.isColumnSelected(4)) {
            try {
                ...
                if (wPergunta == true) {
                    ...
                    objBairro = new Bairro();
                    objBairro.setId_bairro(Integer.parseInt(codigo));
                    lblId.setText("ID");
                    objBairroController = new BairroController(objBairro, null);
